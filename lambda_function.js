...
const SKILL_NAME = 'Bitcoin Buddy';
...
const handlers = {
    ...
    'TotalValueIntent': function () {
        let numberOfCoins = this.event.request.intent.slots.NumberOfCoins.value;
        getQuote(this,numberOfCoins);
    },
...
function getQuote(reference,numberOfCoins) {
                 ...
                 if (quoteDataJson.hasOwnProperty("rate")) {
                    ...
                    let total =  Math.floor(rate * numberOfCoins);
                     ...
                     if (numberOfCoins === 1) {
                        ...
                        responseQuote = `${numberOfCoins} bitcoins are worth ${total} U.S. dollars`;
                     }
                    console.log(responseQuote)
                    reference.response.speak(responseQuote);
